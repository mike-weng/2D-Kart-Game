...
public class Camera {
	 ...
	 *            The height of the camera viewport (pixels).
	 * @param player
	 *            The player, to get the player's location.
	 */
	public Camera(int width, int height, Kart player) {
		this.width = width;
		this.height = height;
		follow(player);
	}
	 ...
	 *            The player, to get the player's location.
	 */
	public void follow(Kart player) {
	 ...
	 * 
	 * @param left
	 *            New left x coordinate of the camera (pixels).
	 * @param top
	 *            New top y coordinate of the camera (pixels).
	 */
